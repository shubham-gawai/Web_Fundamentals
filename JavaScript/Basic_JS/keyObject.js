/*
    WAF  so that it returns true if the object passed to it contains 
    Property key as Alan, Jeff, Sarah and Ryan 
    and returns false if it does not contain any one 
    of the following keys or any different key
*/
